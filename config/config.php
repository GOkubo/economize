...
$conf['settings']['app.title'] = 'Economize';
$conf['settings']['default.timezone'] = 'America/Sao_Paulo';
$conf['settings']['allow.self.registration'] = 'true';
$conf['settings']['admin.email'] = 'guilhokubo@hotmail.com.br';
$conf['settings']['admin.email.name'] = 'Economize';
...
$conf['settings']['database']['password'] = '1q2w3e4r';
$conf['settings']['database']['hostspec'] = '127.0.0.1';
$conf['settings']['database']['name'] = 'economize';
$conf['settings']['phpmailer']['mailer'] = 'guilhokubo@hotmail.com.br';
$conf['settings']['phpmailer']['smtp.host'] = 'smtp.mercadocamargo.com.br';
$conf['settings']['phpmailer']['smtp.port'] = '587';
$conf['settings']['phpmailer']['smtp.secure'] = '';
$conf['settings']['phpmailer']['smtp.auth'] = 'true';
$conf['settings']['phpmailer']['smtp.username'] = 'mercadocamargo@mercadocamargo.com.br';
$conf['settings']['phpmailer']['smtp.password'] = 'mC@3@rg0';
